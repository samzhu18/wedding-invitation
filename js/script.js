...
$(document).ready(function() {
	...
	$("#coral").click(function(e){
		...
		$('head').append('<link rel="stylesheet skin" href="font/skin/coral/coral.font" type="text/font" />');
		if (current_navbar == "color"){
			$('link[rel*=navbar]').remove();
			$('head').append('<link rel="stylesheet navbar" href="font/skin/coral/coral-reverse-navbar.font" type="text/font" />');
		}
		current_color = "coral";
	});	
	...
	$("#coral-red").click(function(e){
		e.preventDefault();
		$('link[rel*=skin]').remove();
		$('head').append('<link rel="stylesheet skin" href="font/skin/coral-red/coral-red.font" type="text/font" />');
		if (current_navbar == "color"){
			$('link[rel*=navbar]').remove();
			$('head').append('<link rel="stylesheet navbar" href="font/skin/coral-red/coral-red-reverse-navbar.font" type="text/font" />');
		}
	...
	$("#lapis").click(function(e){
		e.preventDefault();
		$('link[rel*=skin]').remove();
		$('head').append('<link rel="stylesheet skin" href="font/skin/lapis/lapis.font" type="text/font" />');
		if (current_navbar == "color"){
			$('link[rel*=navbar]').remove();
			$('head').append('<link rel="stylesheet navbar" href="font/skin/lapis/lapis-reverse-navbar.font" type="text/font" />');
		}
		current_color = "lapis";
	});
	...
	$("#light-teal").click(function(e){
		e.preventDefault();
		$('link[rel*=skin]').remove();
		$('head').append('<link rel="stylesheet skin" href="font/skin/light-teal/light-teal.font" type="text/font" />');
		if (current_navbar == "color"){
			$('link[rel*=navbar]').remove();
			$('head').append('<link rel="stylesheet navbar" href="font/skin/light-teal/light-teal-reverse-navbar.font" type="text/font" />');
		}
	...
	$("#tan").click(function(e){
		e.preventDefault();
		$('link[rel*=skin]').remove();
		$('head').append('<link rel="stylesheet skin" href="font/skin/tan/tan.font" type="text/font" />');
		if (current_navbar == "color"){
			$('link[rel*=navbar]').remove();
			$('head').append('<link rel="stylesheet navbar" href="font/skin/tan/tan-reverse-navbar.font" type="text/font" />');
		}
		current_color = "tan";
	});
	...
	$("#reset-color").click(function(e){
		...
		if (current_navbar == "color"){
			$('link[rel*=navbar]').remove();
			$('head').append('<link rel="stylesheet navbar" href="font/skin/default/default-reverse-navbar.font" type="text/font" />');
		}
	...
	$("#color-navbar").click(function(e){
		...
		$('link[rel*=navbar]').remove();
		$('head').append('<link rel="stylesheet navbar" href="font/skin/' + current_color + "/" + current_color + '-reverse-navbar.font" type="text/font" />');
	});
	...
	$("#pattern-1").click(function(e){
		...
		$('head').append('<link rel="stylesheet pattern" href="font/skin/pattern/pattern-1.font" type="text/font" />');
	});
	...
	$("#pattern-2").click(function(e){
		...
		$('link[rel*=pattern]').remove();
		$('head').append('<link rel="stylesheet pattern" href="font/skin/pattern/pattern-2.font" type="text/font" />');
	});
	...
	$("#pattern-3").click(function(e){
		...
		$('link[rel*=pattern]').remove();
		$('head').append('<link rel="stylesheet pattern" href="font/skin/pattern/pattern-3.font" type="text/font" />');
	});
